...
<html>
    ...
    <body>
        <jsp:useBean id="genres" class="org.javabeans.workwithderby.Show_to_Update_genre">
        </jsp:useBean>
        <h1>Зміст</h1>
        ...
        btn.onclick = function() {
            ...
            if(/[^[0-9]/.test(с)){
                ...
                if (idchecked.trim() === '') {
                    ...
                    location.href = "/RalenkoV_301z_Lb1-war/UpdateSelected_genre?idchecked=" + idchecked + 
